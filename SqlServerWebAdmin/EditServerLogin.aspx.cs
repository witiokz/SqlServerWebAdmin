...
namespace SqlServerWebAdmin
{
    public partial class EditServerLogin : System.Web.UI.Page
    {
        ...
        protected void DatabaseAccessGrid_Databound(object sender, DataGridItemEventArgs e)
        {
            ...
            {
                Database database = databases[(string)DatabaseAccessGrid.DataKeys[e.Item.ItemIndex]];
        ...
        private bool Save()
        {
            ...
            try
            {
                ...
                {
                    Database database = databases[(string)DatabaseAccessGrid.DataKeys[item.ItemIndex]];
