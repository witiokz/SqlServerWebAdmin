...
{
    public partial class Views : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            FilterViewsButton_Click(null, null);
        }

        protected void FilterViewsButton_Click(object sender, System.EventArgs e)
        {
            try
            {
                DbServer.Connect();
            ...
            DbServer.GetDefaultInitFields(typeof(Microsoft.SqlServer.Management.Smo.View)); 
            DbServer.SetDefaultInitFields(typeof(Microsoft.SqlServer.Management.Smo.View), "IsSystemObject");
            Microsoft.SqlServer.Management.Smo.ViewCollection views = Database.Views;
            ...
            {
                Microsoft.SqlServer.Management.Smo.View sproc = views[i];
